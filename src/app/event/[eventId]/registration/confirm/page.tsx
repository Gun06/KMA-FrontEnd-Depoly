...
import { useEventUseableUI } from "../apply/shared/hooks/useEventUseableUI";
...
export default function ConfirmPage({ params }: { params: { eventId: string } }) {
  ...
  const showGroupInquiry = !isUseableUILoading && useableUI.groupRegistrationEnabled;
  ...
  const handleGroupConfirm = () => {
    if (!useableUI.groupRegistrationEnabled) return;
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            {/* 개인 신청 조회 */}
            <div
              className={`bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8 border-2 border-gray-200 hover:border-blue-500 transition-all duration-300 cursor-pointer ${
                showGroupInquiry ? "w-full" : "w-full max-w-lg"
              }`}
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-sm sm:text-base md:text-xl font-bold text-black mb-2 sm:mb-3 md:mb-4">개인 신청 조회</h3>
            ...
            {showGroupInquiry && (
              <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8 border-2 border-gray-200 hover:border-blue-500 transition-all duration-300 cursor-pointer"
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-sm sm:text-base md:text-xl font-bold text-black mb-2 sm:mb-3 md:mb-4">단체 신청 조회</h3>
