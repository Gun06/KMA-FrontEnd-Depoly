...
import { createEventFaq } from '@/data/faq/event';
...
export default function Page() {
  ...
  const [answerFiles, setAnswerFiles] = useState<FaqFile[]>([]); // ✅ 답변 첨부
  ...
  const handleSave = async () => {
    ...
    try {
      createEventFaq(
        ...
        { adminName: '관리자' }                // 여러 관리자 대응 시 현재 로그인명으로 교체
      );
      alert('FAQ가 성공적으로 저장되었습니다!');
      router.push(`/admin/boards/faq/events/${eventId}`); // 목록으로 이동
    } catch (e) {
      console.error(e);
