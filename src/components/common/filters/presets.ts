      ...
      fields: [
        {
          ...
          options: [
            { label: "전체", value: "ALL" },
            { label: "이름", value: "NAME" },
            { label: "입금자명", value: "PAYMENTER_NAME" },
            { label: "단체명", value: "ORGANIZATION" },
            { label: "메모", value: "MEMO" },
            { label: "상세메모", value: "DETAIL_MEMO" },
            { label: "비고", value: "NOTE" },
            { label: "매칭로그", value: "MATCHING_LOG" },
            { label: "생년월일", value: "BIRTH" },
            { label: "연락처", value: "PH_NUM" },
          ],
        },
        {
          label: "입금여부",
          options: [
            ...
            { label: "결제완료", value: "COMPLETED" },
            { label: "확인필요", value: "MUST_CHECK" },
            { label: "차액환불요청", value: "NEED_PARTITIAL_REFUND" },
            { label: "전액환불요청", value: "NEED_REFUND" },
            { label: "전액환불완료", value: "REFUNDED" },
          ],
        },
