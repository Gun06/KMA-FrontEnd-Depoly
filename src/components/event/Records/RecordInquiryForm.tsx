  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-3 sm:mb-4">
        <p className="text-[11px] tracking-[0.12em] text-gray-400 mb-1">INDIVIDUAL RECORD</p>
        <h2 className="text-lg sm:text-xl font-semibold text-black text-left">개인 참가자 정보</h2>
      </div>

      {/* 안내 문구 */}
      <div className="mb-10 sm:mb-14 text-left">
        <div className="pl-3 border-l-2 border-gray-200">
          <p className="text-sm sm:text-base text-black leading-relaxed mb-1 font-thin">
