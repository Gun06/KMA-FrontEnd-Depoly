...
export default function ApiBannerSlide({
  ...
  return (
    ...
    >
      ...
      {showOverlay && (
        <div
          className="absolute left-3 right-4 top-[calc(var(--kma-main-header-offset,64px)+0.75rem)] z-10 flex max-w-[min(100%,1000px)] flex-col items-start pb-[clamp(5.25rem,22vw,8.25rem)] text-left sm:left-4 sm:right-6 sm:top-[calc(var(--kma-main-header-offset,64px)+0.9rem)] sm:pb-[clamp(6.75rem,28vw,10rem)] md:left-5 md:right-8 md:top-[calc(var(--kma-main-header-offset,64px)+1.05rem)] lg:right-auto lg:left-[6%] lg:top-[max(24%,calc(var(--kma-main-header-offset,64px)+1rem))] lg:max-w-[min(1000px,64vw)] lg:px-0 lg:pb-0 xl:top-[max(26%,calc(var(--kma-main-header-offset,64px)+1.25rem))]"
        >
          {hasDateRow && (
