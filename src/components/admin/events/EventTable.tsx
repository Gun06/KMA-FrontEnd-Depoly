...
export default function EventTable({
  ...
  const columns: Column<EventRow>[] = [
    ...
    { key: 'date', header: '개최일', width: 120, align: 'center', className: 'text-[#6B7280] whitespace-nowrap' },
    {
      key: 'title',
      header: '대회명',
      align: 'left',
    ...
    },
    {
      ...
      align: 'center',
      render: (r) =>
        r.isPublic ? <span className="text-[#1E5EFF]">공개</span> : <span className="text-[#D12D2D]">비공개</span>,
    },
  ];
