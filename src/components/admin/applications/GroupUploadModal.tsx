...
import { uploadGroupForm } from './api/groupUpload';
...
export default function GroupUploadModal({
  isOpen,
  onClose,
  eventId,
  onSuccess,
  ...
  const handleUpload = async () => {
    ...
    setIsUploading(true);
    try {
      await uploadGroupForm(eventId, file);
      toast.success('단체 신청 양식이 성공적으로 업로드되었습니다.');
      onSuccess?.();
      handleClose();
    } catch (error) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl w-[90vw] max-w-[600px] flex flex-col mx-4">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-900">단체 신청 양식 업로드</h2>
          <button
            onClick={handleClose}
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
              ...
              <ul className="text-xs text-blue-800 space-y-1 list-disc list-inside">
                <li>단체 신청 양식 Excel 파일(.xlsx, .xls)만 업로드 가능합니다.</li>
