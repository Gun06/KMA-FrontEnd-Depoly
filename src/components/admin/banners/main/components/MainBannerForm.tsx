...
type Props = {
  ...
  onChange?: (next: MainBannerFormData) => void;
  imageFile?: File | null;
      ...
      <div className="border-t border-r border-b border-[#E5E7EB]">
        <div className="divide-y divide-[#E5E7EB]">
          ...
          <div className={pad}>
            <FormRow label="제목">
              <TextField
                placeholder="큰 제목(예: 2025 전주 남강 마라톤)"
                value={value.title}
                onChange={(e) =>
          ...
          <div className={pad}>
            <FormRow label="부제목">
              <TextField
                ...
                onChange={(e) =>
                  readOnly ? undefined : patch({ subtitle: e.currentTarget.value })
                }
                className={`${fieldCls} ${computedInputCls} ${textDimCls}`}
                readOnly={readOnly}
              />
          ...
          <div className={pad}>
            <FormRow label="날짜">
              <TextField
                ...
                value={value.date}
                onChange={(e) =>
                  readOnly ? undefined : patch({ date: e.currentTarget.value })
                }
                className={`${fieldCls} ${computedInputCls} ${textDimCls}`}
                readOnly={readOnly}
              />
...
// 타입 export
export type { MainBannerFormData } from '../types';
